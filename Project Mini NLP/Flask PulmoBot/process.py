...
def load_response():
    global responses
    responses = {}
    with open('dataset\PulmoBot.json') as content:
...
def preparation():
    ...
    tokenizer = pickle.load(open('C:/Users/yasmi/Project Mini NLP/Flask PulmoBot/model/tokenizers.pkl', 'rb'))
    le = pickle.load(open('C:/Users/yasmi/Project Mini NLP/Flask PulmoBot/model/le.pkl', 'rb'))
    model = keras.models.load_model('C:/Users/yasmi/Project Mini NLP/Flask PulmoBot/model/model.h5')
